...
export class UsuarioRolController {
  ...
  async get(
    ...
    return this.usuarioRepository.tiene(id).get(filter);
  }
  ...
  async create(
    ...
    return this.usuarioRepository.tiene(id).create(rol);
  }
  ...
  async patch(
    ...
    return this.usuarioRepository.tiene(id).patch(rol, where);
  }
  ...
  async delete(
    ...
    return this.usuarioRepository.tiene(id).delete(where);
  }
}
